...
@Injectable()
export class AuthRepository implements AuthCommandProvider, AuthQueryProvider, OnModuleInit {
    constructor(
    ...
    async saveUserWithOAuthAccount(user: UserRecord, key: string, account: OAuthAccountRecord) {
        await this.dataSource.transaction(async (manager) => {
            await manager.getRepository(UserEntity).save(this.toUserEntity(user));
            await manager.getRepository(OAuthAccountEntity).save({
                accountKey: key,
