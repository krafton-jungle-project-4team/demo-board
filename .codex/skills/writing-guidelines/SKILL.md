...
In Codex, use the available web browsing tool to retrieve the latest rules. If
you use the shell instead and the network is blocked, rerun the fetch with
escalated network permission. The fetched content contains all rules and output
format instructions.
